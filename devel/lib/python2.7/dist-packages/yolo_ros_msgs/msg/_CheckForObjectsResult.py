...
"""autogenerated by genpy from yolo_ros_msgs/CheckForObjectsResult.msg. Do not edit."""
import codecs
import sys
...
class CheckForObjectsResult(genpy.Message):
  ...
  _type = "yolo_ros_msgs/CheckForObjectsResult"
...
"""
  ...
  _slot_types = ['int16','yolo_ros_msgs/BoundingBoxes']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.bounding_boxes is None:
        self.bounding_boxes = yolo_ros_msgs.msg.BoundingBoxes()
    else:
      self.id = 0
      self.bounding_boxes = yolo_ros_msgs.msg.BoundingBoxes()
